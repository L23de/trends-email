"""
Used to generate Google OAuth2 tokens for a more secure way to connect to a Gmail account
Attempts to look for an existing OAuth token, if not found, will generate a new token
